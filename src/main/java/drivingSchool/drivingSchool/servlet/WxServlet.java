...
import drivingSchool.drivingSchool.util.MessageHandlerUtil;

/**
 * 使用@WebServlet注解配置WxServlet,urlPatterns属性指明了WxServlet的访问路径
 * Servlet implementation class AccountSumaryServlet
 */
...
public class WxServlet extends HttpServlet {
    ...
    * 比如这里我将Token设置为NickLian
    */
   private final String TOKEN = "NickLian";
