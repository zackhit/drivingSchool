package drivingSchool.drivingSchool.servlet;
...
import drivingSchool.drivingSchool.domain.AccessToken;
import drivingSchool.drivingSchool.domain.AccessTokenInfo;
import drivingSchool.drivingSchool.util.NetWorkHelper;
                 ...
                 while (true) {
                     try {
                         ...
                         if (AccessTokenInfo.accessToken != null) {
                             ...
                             //获取失败
                             Thread.sleep(1000 * 5); //获取的access_token为空 休眠3秒
                         }
                     } catch (Exception e) {
